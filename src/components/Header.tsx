      ...
      <div className="header">
            <div className="bg-[#2DC275] grid grid-cols-3 py-8 px-24">
                ...
                <div className="flex">
                    ...
                    <button className="bg-white p-2 rounded-r border border-gray-300 border-l-0 hover:text-red-500">
                        <Link to="#">Search</Link>
                    </button>
                </div>
            ...
            <div className="bg-black grid grid-cols-2 py-4 px-24 ">
                <div>
                    <ul>
                        <li className="text-white px-4 inline-block"><NavLink to="music">Music</NavLink></li>
                        <li className="text-white px-4 inline-block"><NavLink to="theaters">Theaters & Art</NavLink></li>
                        <li className="text-white px-4 inline-block"><NavLink to="sport">Sport</NavLink></li>
                        <li className="text-white px-4 inline-block"><NavLink to="other">Others</NavLink></li>
                    </ul>
                </div>
